...
/**
 * Periodically log information about all used URLs defined in routers
 * Usage:
 *
 * require {urlMetrics, log} = require('@storyous/common-utils')
 * urlMetrics.publishMetrics(log, app)
 *
 * @param log Logger
