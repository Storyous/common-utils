...
const configuration = {
    ...
    /**
     * Constructs testing DB url for testing pipelines from desired prefix and commit hash if present
     * Makes sure that the desired database name does not exceed MongoDB's length limit of database name
     *
     * @param {string} prefix
     * @param {string} [commit]
     * @returns {string}
