 ...
 * @returns {Promise.<Response|string|*>} - Returns Response object or parsed body value if parseResponseAs is specified
 */
async function fetch (url, options = {}) {
    ...
    if (expectOk && !response.ok) {
        const responseText = await response.text().catch(() => 'RESPONSE BODY NOT PARSABLE');
